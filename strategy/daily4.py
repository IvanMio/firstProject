...
def strategy(symbol_in, volume_in, target_range_in, stop_range_in,
    ...
    for dl_date in date_list:
        ...
        # print('____________________________________________________________________________________________________')
        try:
            date_slice_main = ts.read_range(read_start_dt, read_end_dt)
        except:
            print(
...
#        finally:
        ...
        for ticks_to_target in target_range:
            new_rows_3 = list()
            for ticks_to_stop in stop_range:
                print(tick, ticks_to_target, ticks_to_stop, volume, entry_hour)
                date_slice = date_slice_main.copy()
                ...
                new_rows_3.append(new_row)
                # trades = trades.append(new_row, ignore_index=True)
            new_rows_2 += new_rows_3
        new_rows += new_rows_2
