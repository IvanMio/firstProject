...
from daily4 import strategy, open_hdf5_files, check_file_date_range
...
def daily_trades(name):
    ...
    trades = strategy(symbol_i, volume_i, target_range, stop_range,
...
if __name__ == '__main__':
    pool = Pool(10)
    trades_list = pool.map(daily_trades, hour_range)
    print(len(trades_list))
    # h5_trades = pd.HDFStore(path + 'trades_AUDNZD.h5', 'a')
    # h5_trades = pd.HDFStore(path + 'trades-AUDNZD-20200101120000-20210610112059_1000.h5', 'a')
    # h5_trades = pd.HDFStore(path + 'trades-AUDNZD-20110101120000-20210610094559_1000.h5', 'a')
    # h5_trades = pd.HDFStore(path + 'trades-AUDNZD-20200101120000-20210610112059_range_15_2000_50.h5', 'a')
    h5_trades = pd.HDFStore(path + 'trades-AUDNZD-20110101120000-20210610094559_range_15_2000_50.h5', 'a')
